  ...
  return (
    <Formik
      ...
      validate={(values) => {
        ...
        // Master's degree fields - only validate if postgrad is selected
    ...
    >
      {({ isSubmitting, values, setFieldValue }) => {
        const updateGrantAndLoanFields = (
          ...
          const totalMaintenanceLoan =
            fees.maintenanceLoan * values.courseLength;
          const totalMaintenanceGrant =
        ...
        return (
          <Form className="flex flex-col gap-4">
            ...
            <div className="grid grid-cols-2 gap-2">
              <label
                className={`flex items-center justify-center border-2 rounded-sm cursor-pointer transition-colors ${
                  values.postgrad === "yes"
                    ? "border-secondary bg-secondary bg-opacity-10"
                    : "border-text-muted hover:border-secondary"
                }`}
